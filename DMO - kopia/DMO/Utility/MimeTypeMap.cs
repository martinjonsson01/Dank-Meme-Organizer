...
namespace DMO.Utility
{
    public static class MimeTypeMap
    {
        ...
        public static List<string> GetExtensionsOfMimeType(string mimeType)
        {
            var mimeExtensions = new List<string>();
            foreach (var pair in _mappings.Value)
            {
                var valueMimeType = pair.Value.Split('/').FirstOrDefault();
                if (valueMimeType.Equals(mimeType, StringComparison.InvariantCultureIgnoreCase))
                    mimeExtensions.Add(pair.Key);
            }
