...
namespace DMO.Utility.Logging
{
    public class LifecycleLog
    {
        ...
        /// <summary>
        /// Logs application OnStart.
        /// </summary>
        /// <param name="startKind">The kind of startup to log.</param>
        /// <param name="args">The arguments of the startup to log.</param>
        public static void AppOnStart(StartKind startKind, IActivatedEventArgs args)
        {
            EventLog.Log.Info($"Application is starting with start kind {startKind}");
            EventLog.Log.Info($"Start reason {args.Kind}, previous state {args.PreviousExecutionState}");
        }
        ...
        /// <summary>
        /// Logs reason for extension revokation.
        /// </summary>
        /// <param name="reason">The result to log.</param>
        public static void ExtensionRevoked(ExtendedExecutionRevokedReason reason)
        {
            EventLog.Log.Info($"Extension revoked due to {reason}");
        }
